...
private:
  void appendLocalChunk(size_t count);
  ...
  int chunk_size_;
  bool online_fusion_enabled_, is_ground_station_, use_udpros_;
  double chunk_flush_interval_, communication_range_;
  ros::Time last_buffer_update_time_;
